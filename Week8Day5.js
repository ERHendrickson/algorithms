...
// how can the method get the counter if it never get passed?
    // HINT: when you call the recursive, you may need to pass in one 
    // more argument
    // and because of that, you will have to change the signature
